...
```bash
lambda-dotnetcore3.1-step-otel$ sam build
```
...
```bash
lambda-dotnetcore3.1-step-otel$ sam logs -n StockCheckerFunction --stack-name lambda-dotnetcore3.1-step-otel --tail
```
...
```bash
lambda-dotnetcore3.1-step-otel$ dotnet test tests/StockChecker.Test
```
...
```bash
aws cloudformation delete-stack --stack-name lambda-dotnetcore3.1-step-otel
```
